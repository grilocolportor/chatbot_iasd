...
def config_rag_chain(model_class, retriever):
    ...
    qa_prompt = PromptTemplate.from_examples(
        examples=[token_s + qa_prompt_template + token_e],
        suffix="",
...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = [
        AIMessage(content="Olá, sou seu assistente virtual! Como posso ajudar você hoje?")
    ]
